...
// ── Q50 — The Identity Finale ─────────────────────────────────────────────────
// The exam ends where it began: with your name. You typed it back on Q1; recall it
// now. Relocated from the old 30-level finale and rebalanced for a 50-question run.
...
export const drawLevel50 = (gc: GameContext) => {
  ...
  if (state.levelSubPhase === 'win') {
    ...
    ctx.fillText('All fifty questions, behind you. Your certificate awaits.', cx, topBoxY + topBoxHeight * 0.56);
