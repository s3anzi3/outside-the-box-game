...
export const LEVEL_DATA: LevelEntry[] = [
  ...
  { title: "Q33", lines: ["Quality control. One word in here is wrong.", "Read it like it matters — because it does."] },
  { title: "Q34", lines: ["One of these does not belong with the others.", "Trust the part of your eye that already noticed."] },
  { title: "Q35", lines: ["A simple test of focus. Watch the panels, then repeat the pattern.", "Corporate insists on measuring 'attention to detail.'"] },
  ...
  { title: "Q37", lines: ["Count the squares. All of them.", "The little ones are not the only ones, candidate."] },
  { title: "Q38", lines: ["Find the pattern and continue it.", "Watch which way it's turning."] },
  { title: "Q39", lines: ["Light every panel. Each switch is contagious.", "One click changes its neighbours too."] },
  { title: "Q40", lines: ["█▒ The exam has crashed. ▒█", "A tap won't fix this. Commit — hold it down and don't let go."] },
  { title: "Q41", lines: ["Five letters, one real word. Rearrange them.", "Only one arrangement actually means something."] },
  { title: "Q42", lines: ["A little arithmetic. Read it very literally.", "After the first time, the number isn't 25 anymore, is it?"] },
  ...
  { title: "Q45", lines: ["Just press submit and we can move on.", "...it seems the button has other ideas. Back it into a corner."] },
